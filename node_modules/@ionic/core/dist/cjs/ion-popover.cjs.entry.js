...
const index = require('./index-ea0555d6.js');
...
const overlays = require('./overlays-d2e50d5e.js');
const ionicGlobal = require('./ionic-global-a54cbba1.js');
const theme = require('./theme-d1c573d2.js');
const index$2 = require('./index-9d02ee85.js');
const animation = require('./animation-c2840aea.js');
require('./index-c8d52405.js');
require('./hardware-back-button-d76ddd64.js');
...
const Popover = class {
    ...
    render() {
        ...
        return (index.h(index.Host, Object.assign({ key: 'b35e04a59d2feff922709efc5045e4e9f65db80d', "aria-modal": "true", "no-router": true, tabindex: "-1" }, htmlAttributes, { style: {
                zIndex: `${20000 + this.overlayIndex}`,
            }, class: Object.assign(Object.assign({}, theme.getClassMap(this.cssClass)), { [mode]: true, 'popover-translucent': this.translucent, 'overlay-hidden': true, 'popover-desktop': desktop, [`popover-side-${side}`]: true, 'popover-nested': !!parentPopover }), onIonPopoverDidPresent: onLifecycle, onIonPopoverWillPresent: onLifecycle, onIonPopoverWillDismiss: onLifecycle, onIonPopoverDidDismiss: onLifecycle, onIonBackdropTap: this.onBackdropTap }), !parentPopover && index.h("ion-backdrop", { tappable: this.backdropDismiss, visible: this.showBackdrop, part: "backdrop" }), index.h("div", { key: '99d26b7ebd403061f4fe75c10b8106d5795cbbc0', class: "popover-wrapper ion-overlay-wrapper", onClick: dismissOnSelect ? () => this.dismiss() : undefined }, enableArrow && index.h("div", { class: "popover-arrow", part: "arrow" }), index.h("div", { key: '6179601846f042b7b3be20c93845464ec8bef98a', class: "popover-content", part: "content" }, index.h("slot", { key: '2ba4f3ba26adfd3d42fa78ca6b6561d4088be8a8' })))));
    }
